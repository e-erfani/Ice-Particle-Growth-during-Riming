...
%     idx_u = find(ismember(habit,'P1E') | ismember(habit,'P1E-A') | ismember(habit,'P1E-F') ...
%         | ismember(habit,'P1E-FA') ) ;
    idx_u = find(ismember(habit,'P1D') ...
      ...
      idx_r = find(ismember(habit,'R4C') | ismember(habit,'R4C-A') | ismember(habit,'R4C-F') | ismember(habit,'R4C-FA') ...
          | ismember(habit,'R4B') | ismember(habit,'R4B-A') | ismember(habit,'R4B-F') | ismember(habit,'R4B-FA') |ismember(habit,'R4A') ) ;   
...
%%%%
  for i = 1:length(bin)*2-2
       ...
       ratio_PSD(i) = ratio(round(i/2)) ;       
        ...
        fig_name = 'mass_ratio_SCPP_dendrites';
        fig_dum = figure(2);
...
%      hleg1 = legend(h20,'R4a & R4b & R4c vs. P1e');
