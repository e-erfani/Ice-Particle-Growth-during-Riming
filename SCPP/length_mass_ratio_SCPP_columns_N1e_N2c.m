...
for kk=1:1
    ...
    idx_u = find(ismember(habit,'N1E') | ismember(habit,'N1E-A') | ismember(habit,'N1E-F') | ismember(habit,'N1E-FA')...
        | ismember(habit,'N2C') | ismember(habit,'N2C-A') | ismember(habit,'N2C-F') | ismember(habit,'N2C-FA') ) ;
   
      idx_r = find(ismember(habit,'R4B') | ismember(habit,'R4B-A') | ismember(habit,'R4B-F') | ismember(habit,'R4B-FA') ...
          | ismember(habit,'R4C') | ismember(habit,'R4C-A') | ismember(habit,'R4C-F') | ismember(habit,'R4C-FA') ) ;   
...
%%%%
  for i = 1:length(bin)*2-2
       ...
       ratio_PSD(i) = ratio(round(i/2)) ;       
        ...
        fig_name = 'mass_ratio_SCPP_column_N1e_N2c';
        fig_dum = figure(2);
